...
export default function Navbar() {
  return (
    <div className="flex justify-around  bg-sky-600 text-white p-3" id="home">
...
<button className="text-xl m-2">Sign In</button>
<button className="text-xl text-sky-600 bg-white px-6 py-0 rounded-2xl m-2">Sign Up</button>
      </div>
